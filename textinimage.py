...
class Stegno:
    ...
    def main(self,root):
        ...
        title.grid(pady=10)
        b_encode = Button(f,text="Encode",command= lambda :self.frame1_encode(f), padx=14, bg = "Bisque", bd = 5, fg = "Black")
        b_encode.config(font=('TimesNewRoman 14 bold'))
        #b_encode.place(x=700, y= 200)
        b_encode.grid(pady=12)
        b_decode = Button(f, text="Decode",padx=14,command=lambda :self.frame1_decode(f),bg = "Bisque", bd = 5, fg = "Black")
        b_decode.config(font=('TimesNewRoman 14 bold'))
    ...
    def frame1_decode(self,f):
        ...
        l1.grid()
        bws_button = Button(d_f2, text='Select', command=lambda :self.frame2_decode(d_f2),bg = "Bisque", bd = 5, fg = "Black")
    ...
    def frame1_encode(self,f):
        ...
        bws_button = Button(f2,text='Select',command=lambda : self.frame2_encode(f2),bg = "Bisque", bd = 5, fg = "Black")
        bws_button.config(font=('TimesNewRoman 14 bold'))
        bws_button.grid(pady = 15)
    ...
    def frame2_encode(self,f2):
        ...
        if not myfile:
            ...
            text_area.grid()
            encode_button = Button(ep, text='Cancel', command=lambda : Stegno.home(self,ep),bg = "Bisque", bd = 5, fg = "Black")
            encode_button.config(font=('TimesNewRoman 14 bold'))
