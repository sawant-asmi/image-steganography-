...
if "__main__":
    ...
    #encoded_image_path = "C:\python project\encoded.png"
    #decoded_image_path = "C:\python project\decoded.png"

   # encoded_image_path = input("Enter the path of encoded image location with extension : ")
    #decoded_image_path = input("Enter the name of decoded image with extension :")

    if cmd == 1:
        encoded_image_path = input("Enter the path of encoded image location with extension : ")
        image_to_hide_in_path = input("Enter the path of cover image with extension :")
        image_to_hide_path = input("Enter path of the image to be hidden with extension : ")
